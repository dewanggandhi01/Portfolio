    ...
    gallery: [
      {
        ...
        image: require('../../assets/images/tourism/arunachal-pradesh/tawang-monastery.webp'),
        description: 'Second largest monastery in the world'
      },
      {
        id: 2,
        title: 'Golden Pagoda',
        image: require('../../assets/images/tourism/arunachal-pradesh/GOLDEN-PAGODA-300x225.webp'),
        description: 'Beautiful Buddhist temple in Namsai'
      },
      {
        id: 3,
        title: 'Nuranang Waterfall',
        image: require('../../assets/images/tourism/arunachal-pradesh/nuranang-waterfall-300x225.webp'),
        description: 'Spectacular waterfall near Tawang'
      },
      {
        id: 4,
        title: 'Siang Rush Bridge',
        image: require('../../assets/images/tourism/arunachal-pradesh/siang-rush-bridge.webp'),
        description: 'Iconic hanging bridge over Siang River'
      },
      {
        id: 5,
        title: 'Dirang Valley',
        image: require('../../assets/images/tourism/arunachal-pradesh/DIRANG-FLAGS-300x169.webp'),
        description: 'Prayer flags in scenic Dirang Valley'
      }
    ],
    places: [
      {
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          {stateData && (
            <View style={styles.contentContainer}>
              ...
              {activeTab === 'gallery' && stateData.gallery && (
                <View>
                  <Text style={styles.contentHeader}>
                    Photo Gallery - {selectedState}
                  </Text>
                  <Text style={styles.contentSubheader}>
                    Explore the beauty through stunning photographs
                  </Text>
                  <View style={styles.galleryGrid}>
                    {stateData.gallery.map((item) => (
                      <TouchableOpacity
                        key={item.id}
